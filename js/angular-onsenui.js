/*! angular-onsenui.js for onsenui - v2.0.0-beta.7+react - 2016-03-28 */
  ...
  angular.module('onsen').factory('SplitterSide', function ($onsen, $compile) {
    ...
    var SplitterSide = Class.extend({
      ...
      init: function init(scope, element, attrs) {
        ...
        this._clearDerivingMethods = $onsen.deriveMethods(this, this._element[0], ['isSwipeable', 'getCurrentMode', 'isOpened', 'open', 'close', 'toggle', 'load']);
  ...
  angular.module('onsen').factory('Splitter', function ($onsen) {
    ...
    var Splitter = Class.extend({
      ...
      init: function init(scope, element, attrs) {
        ...
        this._clearDerivingMethods = $onsen.deriveMethods(this, this._element[0], ['getDeviceBackButtonHandler', 'openRight', 'openLeft', 'closeRight', 'closeLeft', 'toggleRight', 'toggleLeft', 'rightIsOpened', 'leftIsOpened', 'loadContentPage']);
